...
var f = (function (){var pred__34044 = cljs.core._EQ_;
var expr__34045 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__34044.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__34045))){
return ((function (pred__34044,expr__34045){
return (function (p1__34038_SHARP_){
return console.warn(p1__34038_SHARP_);
});
;})(pred__34044,expr__34045))
} else {
if(cljs.core.truth_(pred__34044.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__34045))){
return ((function (pred__34044,expr__34045){
...
if(cljs.core.truth_(pred__34044.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__34045))){
return ((function (pred__34044,expr__34045){
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__34048){
...
var opts = map__34049__$1;
var eval_fn = cljs.core.get.call(null,map__34049__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__34051_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__34053,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1519660837525
