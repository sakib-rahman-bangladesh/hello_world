...
var len__25836__auto___26013 = arguments.length;
var i__25837__auto___26014 = (0);
while(true){
if((i__25837__auto___26014 < len__25836__auto___26013)){
args__25843__auto__.push((arguments[i__25837__auto___26014]));

var G__26015 = (i__25837__auto___26014 + (1));
i__25837__auto___26014 = G__26015;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq26012){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq26012));
});
...
var vec__26019 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
...
var first_word = first__26021;
var words = seq__26020__$1;
...
var G__26023 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__26023,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__26023;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__26024_SHARP_){
if(typeof p1__26024_SHARP_ === 'string'){
return p1__26024_SHARP_;
} else {
return cljs.core.seq.call(null,p1__26024_SHARP_);
...
//# sourceMappingURL=util.js.map?rel=1520626830768