...
var m__25424__auto__ = (sablono.util.to_str[goog.typeOf(x__25423__auto__)]);
if(!((m__25424__auto__ == null))){
return m__25424__auto__.call(null,x);
} else {
var m__25424__auto____$1 = (sablono.util.to_str["_"]);
...
var x__25423__auto__ = (((x == null))?null:x);
var m__25424__auto__ = (sablono.util.to_uri[goog.typeOf(x__25423__auto__)]);
if(!((m__25424__auto__ == null))){
return m__25424__auto__.call(null,x);
} else {
var m__25424__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__25424__auto____$1 == null))){
return m__25424__auto____$1.call(null,x);
} else {
...
var len__25835__auto___26012 = arguments.length;
var i__25836__auto___26013 = (0);
while(true){
if((i__25836__auto___26013 < len__25835__auto___26012)){
args__25842__auto__.push((arguments[i__25836__auto___26013]));

var G__26014 = (i__25836__auto___26013 + (1));
i__25836__auto___26013 = G__26014;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__25843__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq26011){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq26011));
});
...
var vec__26018 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var seq__26019 = cljs.core.seq.call(null,vec__26018);
var first__26020 = cljs.core.first.call(null,seq__26019);
var seq__26019__$1 = cljs.core.next.call(null,seq__26019);
var first_word = first__26020;
var words = seq__26019__$1;
...
var G__26022 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__26022,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__26022;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__26023_SHARP_){
if(typeof p1__26023_SHARP_ === 'string'){
return p1__26023_SHARP_;
} else {
return cljs.core.seq.call(null,p1__26023_SHARP_);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__24760__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1520627266084