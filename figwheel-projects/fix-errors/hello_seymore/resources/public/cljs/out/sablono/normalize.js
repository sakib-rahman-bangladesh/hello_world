...
if(((cljs.core.set_QMARK_.call(null,class$__$1)) || (cljs.core.sequential_QMARK_.call(null,class$__$1))) && (cljs.core.every_QMARK_.call(null,(function (p1__26026_SHARP_){
return ((p1__26026_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__26026_SHARP_ === 'string');
}),class$__$1))){
...
return cljs.core.update_in.call(null,G__26028,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__26028;
}
});
...
var len__25835__auto___26031 = arguments.length;
var i__25836__auto___26032 = (0);
while(true){
if((i__25836__auto___26032 < len__25835__auto___26031)){
args__25842__auto__.push((arguments[i__25836__auto___26032]));

var G__26033 = (i__25836__auto___26032 + (1));
i__25836__auto___26032 = G__26033;
continue;
} else {
}
break;
...
var G__26030 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__26030,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1);
} else {
return G__26030;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq26029){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq26029));
});
...
var vec__26039 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__26039,(0),null);
var names = cljs.core.nth.call(null,vec__26039,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__26039,tag_name,names){
return (function (p1__26034_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__26034_SHARP_));
});})(matches,vec__26039,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__26039,tag_name,names){
...
return cljs.core.remove.call(null,cljs.core.nil_QMARK_,((typeof x === 'string')?(function (){var x__25594__auto__ = x;
...
return cljs.core._conj.call(null,cljs.core.List.EMPTY,x__25594__auto__);
})():(((cljs.core.list_QMARK_.call(null,x)) && ((x instanceof cljs.core.Symbol)))?(function (){var x__25594__auto__ = x;
return cljs.core._conj.call(null,cljs.core.List.EMPTY,x__25594__auto__);
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__26042){
var vec__26049 = p__26042;
...
var tag = first__26051;
var content = seq__26050__$1;
...
var vec__26052 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__26052,(0),null);
var id = cljs.core.nth.call(null,vec__26052,(1),null);
var class$ = cljs.core.nth.call(null,vec__26052,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1520627266209